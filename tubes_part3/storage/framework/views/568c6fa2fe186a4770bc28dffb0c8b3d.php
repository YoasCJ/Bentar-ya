        ...
        <div class="lg:col-span-1">
            <div class="bg-white shadow rounded-lg p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-600"><?php echo e($user->department); ?> • <?php echo e($user->batch); ?></p>
                    <?php if($user->description): ?>
                    <p class="mt-4 text-sm text-gray-700"><?php echo e($user->description); ?></p>
                    <?php endif; ?>
                </div>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600 mb-6">
                        ...
                        <?php else: ?>
                            <?php echo e($user->name); ?> hasn't added any portfolio items yet.
                        <?php endif; ?>
                    </p>
                    <?php if($user->id == auth()->id()): ?>
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="profileName" value="<?php echo e($user->name); ?>" required 
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    
                    <div>
                        <label for="profileEmail" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="email" id="profileEmail" value="<?php echo e($user->email); ?>" required 
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="department" id="profileDepartment" required 
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                <option value="Computer Science" <?php echo e($user->department == 'Computer Science' ? 'selected' : ''); ?>>Computer Science</option>
                                <option value="Information Systems" <?php echo e($user->department == 'Information Systems' ? 'selected' : ''); ?>>Information Systems</option>
                                <option value="Design" <?php echo e($user->department == 'Design' ? 'selected' : ''); ?>>Design</option>
                                <option value="Business" <?php echo e($user->department == 'Business' ? 'selected' : ''); ?>>Business</option>
                                <option value="Engineering" <?php echo e($user->department == 'Engineering' ? 'selected' : ''); ?>>Engineering</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="batch" id="profileBatch" required 
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                <option value="2020" <?php echo e($user->batch == '2020' ? 'selected' : ''); ?>>2020</option>
                                <option value="2021" <?php echo e($user->batch == '2021' ? 'selected' : ''); ?>>2021</option>
                                <option value="2022" <?php echo e($user->batch == '2022' ? 'selected' : ''); ?>>2022</option>
                                <option value="2023" <?php echo e($user->batch == '2023' ? 'selected' : ''); ?>>2023</option>
                                <option value="2024" <?php echo e($user->batch == '2024' ? 'selected' : ''); ?>>2024</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="profileDescription" rows="3" 
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"><?php echo e($user->description); ?></textarea>
                    </div>
