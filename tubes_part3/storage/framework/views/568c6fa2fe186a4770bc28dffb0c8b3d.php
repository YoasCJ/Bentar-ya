            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="text-center">
                    <div class="h-24 w-24 rounded-full bg-blue-500 flex items-center justify-center mx-auto mb-4 text-white text-2xl font-bold">
                        <?php echo e(substr($targetUser->name, 0, 1)); ?>

                    </div>
                    <h2 class="text-xl font-semibold text-gray-900"><?php echo e($targetUser->name); ?></h2>
                    <p class="text-gray-600"><?php echo e($targetUser->department); ?> • <?php echo e($targetUser->batch); ?></p>
                    <?php if($targetUser->description): ?>
                    <p class="mt-4 text-sm text-gray-700"><?php echo e($targetUser->description); ?></p>
                    <?php endif; ?>
                </div>
                
                <?php if($targetUser->id == auth()->id()): ?>
                <div class="mt-6">
        ...
        <div class="mt-8">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $warnings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-pink-100 border-l-4 border-pink-500 text-pink-700 p-4 mb-2 rounded">
                    <p class="font-bold"><?php echo e($warning->title); ?> (<?php echo e($warning->level); ?>)</p>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600 mb-6">
                        ...
                        <?php else: ?>
                            <?php echo e($targetUser->name); ?> hasn't added any portfolio items yet.
                        <?php endif; ?>
                    </p>
                    <?php if($targetUser->id == auth()->id()): ?>
                ...
                <form action="<?php echo e(route('profile.update')); ?>" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="profileName" value="<?php echo e($targetUser->name); ?>" required 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        
                        <div>
                            <label for="profileEmail" class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email" name="email" id="profileEmail" value="<?php echo e($targetUser->email); ?>" required 
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="department" id="profileDepartment" required 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                    <option value="Computer Science" <?php echo e($targetUser->department == 'Computer Science' ? 'selected' : ''); ?>>Computer Science</option>
                                    <option value="Information Systems" <?php echo e($targetUser->department == 'Information Systems' ? 'selected' : ''); ?>>Information Systems</option>
                                    <option value="Design" <?php echo e($targetUser->department == 'Design' ? 'selected' : ''); ?>>Design</option>
                                    <option value="Business" <?php echo e($targetUser->department == 'Business' ? 'selected' : ''); ?>>Business</option>
                                    <option value="Engineering" <?php echo e($targetUser->department == 'Engineering' ? 'selected' : ''); ?>>Engineering</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="batch" id="profileBatch" required 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                    <option value="2020" <?php echo e($targetUser->batch == '2020' ? 'selected' : ''); ?>>2020</option>
                                    <option value="2021" <?php echo e($targetUser->batch == '2021' ? 'selected' : ''); ?>>2021</option>
                                    <option value="2022" <?php echo e($targetUser->batch == '2022' ? 'selected' : ''); ?>>2022</option>
                                    <option value="2023" <?php echo e($targetUser->batch == '2023' ? 'selected' : ''); ?>>2023</option>
                                    <option value="2024" <?php echo e($targetUser->batch == '2024' ? 'selected' : ''); ?>>2024</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="profileDescription" rows="3" 
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"><?php echo e($targetUser->description); ?></textarea>
                        </div>
